             ...
             <li class="items-center">
              ...
              <li class="items-center">
                <a
                  ...
                  class="text-xs uppercase py-3 font-bold block text-blueGray-700 hover:text-blueGray-500"
                >
                  <i class="fas fa-user-graduate mr-2 text-sm text-blueGray-700"></i>
                  Etudiants
                </a>
              </li>
				 <li class="items-center">
              ...
              <li class="items-center">
                ...
                >
                  <i class="fas fa-certificate mr-2 text-sm text-orange-500"></i>
                   Certificate
                </a>
              </li>
              <li class="items-center">
                <a
                  ...
                  class="text-xs uppercase py-3 font-bold block text-blueGray-700 hover:text-blueGray-500"
                >
                  <i class="fas fa-tools mr-2 text-sm text-blueGray-500"></i>
                      ...
                      <tr>
                        ...
                        >
                          ...
                          <%=rec.getString("emailuser") %>
							...
							<td><a href="question.jsp?id=<%=rec.getString("idQuiz") %>"> <button
